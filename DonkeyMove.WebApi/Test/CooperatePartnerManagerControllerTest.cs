...
{
    public class CooperatePartnerManagerControllerTest : TestBase
    {
        ...
        public void TestGet()
        {
            var controller = _autofacServiceProvider.GetService<CooperatePartnerManagerController>();
        ...
        public void TestGetList()
        {
            ...
            {
                Stopwatch watch = Stopwatch.StartNew();
                var result = controller.GetList(new QueryCooperatePartnerReq());
                Console.WriteLine(JsonHelper.Instance.Serialize(result));
                watch.Stop();
                Console.WriteLine($"總耗時:{watch.ElapsedMilliseconds}");
            }
        ...
        public void TestAdd()
        {
            ...
            {
                Stopwatch watch = Stopwatch.StartNew();
                var result = controller.Add(new AddCooperatePartnerReq()
                {
                    Name = "測試名稱",                    
        ...
        public void TestUpdate()
        {
            ...
            {
                Stopwatch watch = Stopwatch.StartNew();
                var result = controller.Update(new UpdateCooperatePartnerReq
                {
