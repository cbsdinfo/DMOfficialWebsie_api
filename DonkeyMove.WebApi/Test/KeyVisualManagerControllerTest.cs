...
{
    public class KeyVisualManagerControllerTest : TestBase
    {
        ...
        public void TestGet()
        {
            var controller = _autofacServiceProvider.GetService<KeyVisualManagerController>();
        ...
        public void TestGetList()
        {
            ...
            {
                Stopwatch watch = Stopwatch.StartNew();
                var result = controller.GetList(new QueryKeyVisualReq());
                Console.WriteLine(JsonHelper.Instance.Serialize(result));
                watch.Stop();
                Console.WriteLine($"總耗時:{watch.ElapsedMilliseconds}");
            }
        ...
        //    {
        //        Stopwatch watch = Stopwatch.StartNew();
        //        var result = controller.Add(new AddKeyVisualReq()
        //        {
        //            UnitName = "單元名稱",
        ...
        public void TestUpdate()
        {
            ...
            {
                Stopwatch watch = Stopwatch.StartNew();
                var result = controller.Update(new UpdateKeyVisualReq
                {
