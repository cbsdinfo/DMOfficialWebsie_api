...
{
    public class AboutUsUnitManagerControllerTest : TestBase
    {
        ...
        public void TestGet()
        {
            var controller = _autofacServiceProvider.GetService<AboutUsUnitManagerController>();
        ...
        public void TestUpdate()
        {
            ...
            {
                Stopwatch watch = Stopwatch.StartNew();
                var result = controller.Update(new UpdateAboutUsReq
                {
