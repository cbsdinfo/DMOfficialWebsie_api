...
{
    public class OrgManagerApp : BaseTreeApp<SysOrg,donkeymoveDBContext>
    {
        ...
        /// <exception cref="System.Exception">未能找到該組織的父節點信息</exception>
        ...
        public OrgManagerApp(IUnitWork<donkeymoveDBContext> unitWork, IRepository<SysOrg,donkeymoveDBContext> repository,IAuth auth, 
