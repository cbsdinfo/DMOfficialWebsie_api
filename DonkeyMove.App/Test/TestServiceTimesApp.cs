...
{
    class TestServiceTimesApp : TestBase
    {
        ...
        {
            var app = _autofacServiceProvider.GetService<ServiceTimesApp>();
        ...
        {            
            var app = _autofacServiceProvider.GetService<ServiceTimesApp>();
            var query = new QueryServiceTimesReq();
            try
            {
        ...
        public void TestAdd()
        {
            ...
            try
            {
                var result = app.Add(new AddServiceTimesReq()
                {
                    ServiceName = "服務名稱",
                    NumberTimes = "1,800",                    
                });
        ...
        public void TestUpate()
        {
            ...
            try
            {
                app.Update(new UpdateServiceTimesReq
                {
