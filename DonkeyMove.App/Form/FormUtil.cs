...
namespace donkeymove.App
{
    public class FormUtil
    {
        ...
        {
            string name = item.GetValue("name").ToString();  //控件的名稱
            string value = null;
            JToken data;
        ...
        //       string btnAdd = "<span class=\"pull-right\"><button class=\"btn btn-small btn-success listAdd\" type=\"button\" tbname=\"" + name + "\">添加一行</button></span>"; //添加按鈕
        ...
        //           if (i == tdCount - 1)
        //               listTitle.set(i, "操作");
        //           if (ACTION==(action) && i == tdCount - 1) continue;//如果是查看最后一列不顯示
