...
namespace donkeymove.App
{
    ...
    /// 文件管理
    /// </summary>
    public class FileApp : BaseStringApp<UploadFile,donkeymoveDBContext>
    {
        ...
        public FileApp(IOptions<AppSetting> setOptions, IUnitWork<donkeymoveDBContext> unitWork, IRepository<UploadFile,donkeymoveDBContext> repository,
        ...
        private void SaveFile(string fileName, byte[] fileBuffers)
        {
            ...
            _logger.LogInformation("文件寫入：" + uploadPath);
